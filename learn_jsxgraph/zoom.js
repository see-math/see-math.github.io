...
async function moveslow(old_xa, old_ya, old_xb, old_yb, new_xa, new_ya, new_xb, new_yb) {
    console.log(old_xa, old_ya, old_xb, old_yb, new_xa, new_ya, new_xb, new_yb)
    board.setBoundingBox([old_xa, old_ya, old_xb, old_yb])

    xa_tran = interval_spacing(old_xa, new_xa, 100)
    ya_tran = interval_spacing(old_ya, new_ya, 100)
    xb_tran = interval_spacing(old_xb, new_xb, 100)
    yb_tran = interval_spacing(old_yb, new_yb, 100)
